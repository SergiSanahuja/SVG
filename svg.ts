...
function dibuix(){
    ...
    let xMin = (<HTMLInputElement>document.getElementById("nmin")).value;
    let xMax = (<HTMLInputElement>document.getElementById("nmax")).value;
    let nPunts = (<HTMLInputElement>document.getElementById("punts")).value;
